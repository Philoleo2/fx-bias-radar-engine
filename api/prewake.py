"""API endpoint PREWAKE: serve l'ultimo snapshot PAIR_PREWAKE_V1 calcolato dal
cron orario dedicato. Auth bearer come le altre API; no-store.
...
REL_PATH = os.path.join("reports", "prewake", "prewake_latest.json")
